...
export function TableCustomers1(props: JSX.IntrinsicElements['group']) {
  ...
  const [man_1_lowerbody, man_1_upperbody, woman_1_lowerbody, woman_1_upperbody, eyebrow_eyelash] = [
    TextureAssetsLoader('/textures/bodies/man_1_lowerbody.webp'),
    TextureAssetsLoader('/textures/bodies/man_1_upperbody.webp'),
    TextureAssetsLoader('/textures/bodies/woman_1_lowerbody.webp'),
    TextureAssetsLoader('/textures/bodies/woman_1_upperbody.webp'),
  ...
  return (
      ...
      <group name="Scene">
        <group name="rig_man_1" position={[0, 0.902, -0.003]}>
          ...
          ><meshStandardMaterial alphaMap={eyebrow_eyelash} transparent color={"black"}/></skinnedMesh>
          <skinnedMesh
          ...
          ><meshStandardMaterial map={man_1_lowerbody} lightMap={man_1_lowerbody} lightMapIntensity={1}/></skinnedMesh>
          <skinnedMesh
          ...
          ><meshStandardMaterial map={man_1_upperbody} lightMap={man_1_upperbody} lightMapIntensity={1}/></skinnedMesh>
        ...
        <group name="rig_woman_1">
          ...
          <skinnedMesh
            ...
            morphTargetDictionary={nodes.woman_1_lowerbody.morphTargetDictionary}
            morphTargetInfluences={nodes.woman_1_lowerbody.morphTargetInfluences}
          ><meshStandardMaterial map={woman_1_lowerbody} lightMap={woman_1_lowerbody} lightMapIntensity={1}/></skinnedMesh>
          <skinnedMesh
          ...
          ><meshStandardMaterial map={woman_1_upperbody} lightMap={woman_1_upperbody} lightMapIntensity={1}/></skinnedMesh>
